      ...
      <Card.Body>
        ...
        <ul className="list-group list-group-flush">
          {historique.map((etape) => {
            const user = DataUtilisateur.data?.find(
              (u) => u.id_utilisateur === etape.id_utilisateur
            );
            const structureSrc = DataStructure.data?.find(
              (s) => s.id_structure === etape.id_structure
            );
            const structureDest = DataStructure.data?.find(
              (s) => s.id_structure === etape.id_structure_destinataire
            );
